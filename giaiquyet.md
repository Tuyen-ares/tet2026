...
1) Build / Pre-deploy / Start commands (nên dùng A hoặc B theo Root Directory)
...
1) Thêm biến môi trường (Render → Environment)
...
1) (Tùy chọn) Thêm script migrate cho production vào `backend/package.json`
...
1) Nếu bạn dùng PlanetScale hoặc DB managed khác
...
1) Alternative: chạy migrations trong GitHub Actions
